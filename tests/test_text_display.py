...
def test_the_view_shows_the_omission_and_the_stored_reading_keeps_the_words(tmp_path):
    ...
    # the view is carried to head, not pinned to the migration that made it: a hard
    # number here fails on every later migration and says nothing about the display rule
