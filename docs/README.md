...
| [`research/text-quality/README.md`](research/text-quality/README.md) | What the text layers the site shows are worth: the lexicon-share signal, 166 operator-checked page labels in two samples, and the measured answer — ~110,500 of 931,392 judged text-layer pages are faulty, ~25,000 garbage. Holds the re-read queue's order and the rotation probe. The quality-flag addendum it was written for was WITHDRAWN 2026-09-17; the score stays an internal routing list. |
