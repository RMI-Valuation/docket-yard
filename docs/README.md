...
| 13 | [`contribute.md`](contribute.md) | The `/contribute` page: three lanes (ideas, code, money), what each may and may not promise | planning note 2026-08-26; page draft awaits the operator |
