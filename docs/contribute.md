...
> **Decided 2026-08-26: two lanes, ideas and code. Money is omitted entirely** — the page
> says nothing about it (the operator's choice: silence over "not at present"); the entity
> question (`licensing.md` § Open) comes first. This note is the source
...
| **Money** | none — omitted | Operator's decision 2026-08-26: the page is silent on money | The entity question (`licensing.md` § Open) and whether to name the running cost, before any channel exists |
...
- [x] Two lanes; money omitted (2026-08-26).
