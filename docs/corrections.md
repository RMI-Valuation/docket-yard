...
> **Status: published 2026-08-26 (operator sign-off in session).** The published page is `src/docketyard/web/templates/corrections.html`, served at `/corrections` and linked from every page's footer. This file is the brief the page was written to; the page is the source.
