...
| `docs/adr/` | **0001-0015 all Accepted** (0002-0008 and 0010-0015 carry Validation sections); **0016 Accepted** 2026-08-28 (reviewer identity); **0017 Accepted** 2026-09-01 on the sixth critic pass — a **paper shape** for citation edges, endorsing **no published number**; the exposure test still bars the first published edge, and eight items are owed at the migration (see its § Accepted) |
