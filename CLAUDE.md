...
| `docs/adr/` | **0001-0015 all Accepted** (0002-0008 and 0010-0015 carry Validation sections); **0016 Accepted** 2026-08-28 (reviewer identity); **0017 and 0018 Proposed** 2026-09-01, both cleared by the schema-critic and **awaiting the operator** — 0017 is what ships and at what measured confidence, 0018 the five assertion families; the exposure test still bars the first published edge |
