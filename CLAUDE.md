...
| `docs/adr/` | **0001-0015 all Accepted** (0002-0008 and 0010-0015 carry Validation sections); **0016 Accepted** 2026-08-28 (reviewer identity); **0017 still Proposed** — cleared by the schema-critic 2026-09-01 on its sixth pass, **awaiting the operator's decision**; a clearance of the paper shape only, endorsing no published number |
