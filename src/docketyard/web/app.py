    ...
    *,
    ...
    def robots():
        ...
        lines += [
            ...
            "# An assistant answering a user's question may read the page text through the",
            "# MCP server below (read_page), labelled and linked to the Board's file; that is",
            "# a reading, not a licence to collect or train on it.",
            "#",
